...
A tecnologia possibilita que, através de uma análise complexa de dados, um anúncio pode ser mostrado ao "indivíduo certo" no "momento certo", por exemplo, mostrando um anúncio de fast food quando foi calculado a pessoa pode estar a começar a ter fome, ou um anúncío para cirurgia estética quando não se sentir atraente. Há diversas variações destas técnicas que são vulgarmente referidas como 'marketing comportamental', 'microtargeting' ou "publicidade programática".  
