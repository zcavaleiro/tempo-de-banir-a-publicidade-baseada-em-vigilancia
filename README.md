...
A tecnologia promete que, através de uma análise abrangente de dados, um anúncio pode ser mostrado ao "indivíduo certo" no "momento certo", por exemplo, mostrando um anúncio de fast food quando foi calculado que você pode estar se sentindo peckish, ou para cirurgia estética se não se sentir atraente. Variações desta tecnologia são também vulgarmente referidos como 'comportamental publicidade ' 'microtargeting' ou "publicidade programática".
